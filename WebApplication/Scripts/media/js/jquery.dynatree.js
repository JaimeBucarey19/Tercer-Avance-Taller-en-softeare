 ...
 */
var tipos={
            "sede":"fa fa-institution",
            "carrera":"fa fa-graduation-cap"
          }
/*************************************************************************
 *  Debug functions
 */
	...
	_getInnerHtml: function() {
		...
		if( opts.checkbox && data.hideCheckbox !== true && !data.isStatusNode ) {
            if(data.expand==false)
                res += "<span id='"+data.key+"' class='elementos " + opts.classNames.checkbox + "'></span>";
            else
...
//          noop(); // keep JSLint happy
			...
			if( data.tipo )
                res += "<span class='" + tipos[data.tipo] + "'></span>";
            else
	...
	getSelectedNodes: function(stopOnParents) {
		...
		this.tnRoot.visit(function(node){
			if( node.bSelected ) {
                ...
                if(stopOnParents=='children' && node.childList!=null){
                    nodeList.pop();
                }
			}
		});
