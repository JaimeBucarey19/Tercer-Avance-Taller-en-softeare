(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			"<p class=\"AddOne btn-success btn-rounded btn-outline\" rel=\"" + newName + "\" title=\"Add Selected\">&rsaquo;</p>" +
			"<p class=\"AddAll btn-success btn-rounded btn-outline\" rel=\"" + newName + "\" title=\"Add All\">&raquo;</p>" +
			"<p class=\"RemoveOne btn-success btn-rounded btn-outline\" rel=\"" + newName + "\" title=\"Remove Selected\">&lsaquo;</p>" +
			"<p class=\"RemoveAll btn-success btn-rounded btn-outline\" rel=\"" + newName + "\" title=\"Remove All\">&laquo;</p>" +
			"</div>" +
			...
			$("." + nameModifier + "options .AddAll").click(function() {
                ...
                $("#" + targetName + nameModifier + " :visible").remove().appendTo("#" + targetName);
				OrderMyList();
				return false;
			});
			...
			$("." + nameModifier + "options .RemoveAll").click(function() {
                ...
                $("#" + targetName + " :visible").remove().appendTo("#" + targetName + nameModifier);
				OrderMyList();
				return false;
			});
		});
