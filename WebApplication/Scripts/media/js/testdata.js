...
var users_custom_data={
	"data":[
	//{"id":1, "text":"Project #2", "start_date":"01-04-2013", "duration":"18", "progress": 0.4, "open": true},
{"id":1,"text":"Plan Acciones Colegio Camilo Henriquez","start_date":"01-12-2015","open":true,"priority":"2","progress": 0.4},
	{"id":2, "text":"Mejorar los Resultados", "open": true, "parent":"1","users": ["arudloff", "xrudloff"], "priority": "1"},	
	{"id":3, "text":"Plan Entrenamiento Simce", "parent":"2", "progress": 0.5, "open": true, "users": ["cespinoza"], "priority": "1"},
	{"id":4, "text":'Plan de actividades vinculantes para generar sentido de propósito', "parent":"2", "progress": 0.8, "open": true, "users": ["arudloff", "xrudloff"], "priority": "2"},
	{"id":5, "text":'Desarrollo de un proceso formal y sistemático de supervición de aula, para medir los indices de coherencia cognitiva',  "parent":"2", "progress": 0.2, "open": true, "users": ["cespinoza"], "priority": "3"},
	{"id":6, "text":"Mejorar los Aprendizajes de los Estudiantes", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":7, "text":"Plan de desarrollo actitudinal", "parent":"6", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":8, "text":"Levantar y Diseñar Proceso de Gestión de Casos", "parent":"6", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":9, "text":"Desarrollar, Retener y Atraer Talento", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":10, "text":"Aumentar los espacios de participacion de los Alumnos y Padres", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":11, "text":"Mejorar el diseño de clases y evaluaciones", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":12, "text":"Mejorar la Ejecución de las Clases", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":13, "text":"Desarrollar las competencias claves del Docente", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":14, "text":"Aumentar los espacios para relacionarse y establecer vinculos", "parent":"0", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"},
	{"id":15, "text":"Contar con un clima de estabilidad", "parent":"1", "progress": 0, "open": true, "users": ["arudloff","cespinoza"], "priority": "2"}]
	};
var users_data = {
	"data":[
